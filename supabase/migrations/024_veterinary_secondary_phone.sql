-- Segundo telefono opcional para veterinarias (permite elegir a cual llamar desde la app).

alter table public.veterinary_profiles
  add column if not exists phone_secondary text;

drop function if exists public.get_veterinary_claim_landing(text);
...
drop function if exists public.submit_veterinary_claim_decision(
  text, text, text, text, text, text, text, boolean, boolean, text, text, text, text, text, text, text, boolean, text, text
);
...
grant execute on function public.submit_veterinary_claim_decision(text, text, text, text, text, text, text, boolean, boolean, text, text, text, text, text, text, text, boolean, text, text, text) to anon, authenticated;
